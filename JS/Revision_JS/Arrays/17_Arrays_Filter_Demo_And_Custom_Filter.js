...
let arr1 = [2, 50, 90, 8, 150, 110, 6];
let oarr1 = arr1.myFilter(function(v, i, oarr1){
    console.log(v + "@" + i + "[" + oarr1 + "]");
    if(v % 2 == 1){
        return true;
    } else {
        return false;
...
// if you pass all even values then the oarr will remain empty

let arr = [2, 501, 90, 8, 150, 110, 63];
