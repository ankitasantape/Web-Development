...
2. Formula -> In formula, every token is space separated ( A1 + A3 )
           -> Don't use equals to 
           -> Formula can only be set using formula bar.
***************************************************************           
           Three Scenario Creates here
    First we get address from address bar A1, A2 like and second is formula bar, enter the value in formula bar and press enter
     A1 = 10 , A2 = 20
    1. Enter press
    2. Formula bar -> Formula = get( A1 + A2 )
    3. Next step would be replace value from A1 and A2 , ( 10 + 20 )
    4. Evaluate -> 30
    5. Set value using address bar B1 = 30
*/ 