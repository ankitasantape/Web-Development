...
(async () => {
  ...
  sortByAggregateRatings(moviesData);
  console.log("Successfull...!!!")

})();


function sortByAggregateRatings(moviesData){
  let sortedArr = moviesData.sort(cb);
  function cb(objA, objB){
      // for incresing order
      return objA.ratingCount - objB.ratingCount;
      // for decresing
  ...
  fs.writeFileSync('movies_data/aggregate_rating/aggregate_rating.csv', csv, 'utf-8');
